    ...
    email_html_message = f"""
        ...
        <body>
            <div class="container">
                ...
                <a href="{instance.request.build_absolute_uri('https://vanman.vercel.app/reset-password/')}{reset_password_token.key}" class="button" style=”color:white;”>Reset Password</a>
